...
🗄️ Database Files
<details> <summary>Click to open SQL files</summary>
Open schema.sql
Open queries.sql
Open optimization.sql
</details>
🖼 Screenshots / Examples
Database Schema
<details> <summary>Click to open schema screenshots</summary>

📂 Open Schema Screenshots Folder

</details>
Query Performance
<details> <summary>Click to open performance screenshots</summary>

📂 Open Performance Screenshots Folder
...
👤 Author
Akil Selot
Aspiring Data Analyst | SQL | Big Data | Hadoop | Data Analytics
